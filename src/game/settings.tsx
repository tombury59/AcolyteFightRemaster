...
const meteoriteProjectile: ProjectileTemplate = {
    ...
    renderers: [
        ...
        { type: "projectile", ticks: 12, light: null, shine: 0, smoke: 0.5, fade: "#333", shadow: 0.5 },
...
const kamehameha: Spell = {
    ...
    projectile: {
        ...
        color: '#44ddff',
        renderers: [
            { type: "ray", intermediatePoints: true, ticks: 30, ownerColor: true, shine: 1, glow: 0.2, bloom: 0.005, vanish: 1, light: 0.8 },
        ],
    },
};
...
const retractor: Spell = {
    ...
    projectile: {
        ...
        renderers: [
            ...
            { type: "projectile", ticks: 7, glow: 0.3, selfColor: true },
...
const mines: Spell = {
    ...
    projectile: {
        ...
        color: '#ff009c',
        renderers: [
            { type: "projectile", ticks: 1, light: 1, selfColor: true, colorize: 0.1, bloom: 0.01, shine: 0, glow: 0.2, shadow: 0.3, noPartialRadius: true },
    ...
    effects: [
        {
            icon: "fas fa-snowflake",
            title: "Freeze",
            text: "Freeze nearby enemies for 1.25 seconds.",
        },
    ],
    sound: "iceBomb",
